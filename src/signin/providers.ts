...
// The DATA lives in providers.json because build.mjs needs it too: a <meta>
// CSP cannot allowlist arbitrary PDS hosts (docs/ATPROTO.md § CSP), but it can
// allowlist THESE, and a second list in the build would be the one that drifts.
