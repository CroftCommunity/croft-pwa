...
in at an arbitrary PDS needs a header-level CSP or a per-host relaxation. The rings page
(`rings.html`) is that app, and takes the per-page relaxation — `docs/SECURITY.md` § CSP.
